            ...
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-6">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="includes/admin_login.php" method="post">
                            <h3 class="text-center text-info"> Admin Login </font></h3>
                            <div class="form-group">
                                <label for="username" class="text-info">Email:</label><br>
                                <input type="email" placeholder="Enter Email*" name="admin_email" id="username" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="password" class="text-info">Password:</label><br>
                                <input type="password" placeholder="Enter Password*" name="admin_password" id="password*" class="form-control">
                            </div>
                            <div align="center" class="form-group">
                                
                                <input type="submit" name="admin_login" class="btn btn-info btn-md" value="Log In">
                            </div>
                        </form>
                    </div>
                </div>
